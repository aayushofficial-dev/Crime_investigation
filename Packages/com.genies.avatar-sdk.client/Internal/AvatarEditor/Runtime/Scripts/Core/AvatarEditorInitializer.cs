...
namespace Genies.AvatarEditor.Core
{
...
#endif
    {
        ...
        /// <summary>
        /// Fired when we finish initializing the AvatarEditorSDK. Returns a float which is how long we took to
        /// initialize in milliseconds
        /// </summary>
        internal Action<float> AvatarSdkInitialized;
        ...
        public async UniTask<bool> InitializeAsync(BackendEnvironment targetEnvironment)
        {
            ...
            try
            {
                ...
                AvatarSdkInitialized?.Invoke(DateTimeOffset.UtcNow.ToUnixTimeSeconds() - timeStamp);
